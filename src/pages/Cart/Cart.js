...
import { resetCart, totalAmount, updateTotalAmount } from '../../redux/orebiSlice'
        ...
        >
          ...
          <div className='max-w-[500px] p-4 py-8 bg-white flex gap-4 flex-col items-center rounded-md shadow-lg'>
            ...
            <p className='text-sm text-center px-10 -mt-2'>
              Tu cesta de la compra vive para servir. Dale un propósito: llénalo
              de libros, aparatos electrónicos, vídeos, etc. y hazlo feliz.
            </p>
            <Link to='/shop'>
              <button
                ...
                onClick={() => {
                  console.log({totalAmountCart: totalAmt})
                }}
              >
                Continua Comprando
              </button>
