  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex items-center">
        <p className="text-sm mr-2"> Dejar una reseña </p>
      ...
      <p className="font-normal text-sm">
        <span className="text-base font-medium"> Categorias:</span> Colección
        de primavera, Streetwear, Women Tags: featured SKU: N/A
      </p>
    </div>
  );
};
